    ...
    public static class EmailTemplate
    {
        public static string ConfirmacaoCadastro(IConfiguration configuration, UserDto userDto)
        {
            var corpoEmail = $"<p>Olá {userDto.Nome}, <br> <br> Você foi cadastrado na nossa plataforma e agora pode acompanhar todos os " +
                    ...
                    $"<br> " +
                    $"<label style='font-weight: bold;'>Acesse através do link: <a href='{configuration["Urls:Site"]}'>Entrar</a> </label>" +
                    $"<br> <br>";
            return corpoEmail;
        }

        public static string RecuperarSenha(IConfiguration configuration, User user, string token)
        {
